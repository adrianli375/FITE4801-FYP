...
from keras.layers import SimpleRNN, Dropout, Dense, TimeDistributed
...
# The deep learning baseline trading strategy with the use of the RNN model in the US Stock market. 
class ML(QCAlgorithm):
    ...
    def TrainAlgo(self):
        ...
        self.model.add(SimpleRNN(self.rnn_units, activation='tanh', return_sequences=True))
        self.model.add(Dropout(0.1))
        self.model.add(Dense(64, activation='tanh'))
        self.model.add(Dropout(0.1))
        self.model.add(SimpleRNN(self.rnn_units, activation='tanh'))
        self.model.add(Dropout(0.1))
    ...
    def Initialize(self):
        ...
        self.stock = self.AddEquity(self.instrument, Resolution.Hour).Symbol
