...
# The machine learning baseline trading strategy with the use of the gradient boosting classifier in the cryptocurrency market.
...
class ML(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.tradeConfidenceLevel = 0.45
        self.tradeHistory = 365
        self.npercent = 0.015
        self.stoplosspercent = 0.025 #0 for no stoploss
