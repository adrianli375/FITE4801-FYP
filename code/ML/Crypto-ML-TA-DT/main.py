...
# The machine learning baseline trading strategy with the use of the decision tree classifier in the cryptocurrency market.
...
class ML(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.npercent = 0.1
        self.stoplosspercent = 0.07 #0 for no stoploss
