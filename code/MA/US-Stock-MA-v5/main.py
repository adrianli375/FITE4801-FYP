...
# Version 5 of the algorithm in the US stock market. 
class StockMA(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        ### Parameters
        self.n_days = 200 #Number of days used to calculate MA (= max MA)
        self.default_MA = 50
        self.rolling_window = 15
        self.rolling_reset = 25
        self.MA_coef = 2.5
        self.min_MA = 10
        ...
        self.close_volatility_n_days = 10
        self.close_volatility_coefficient = 0.2
        ### End Parameters
