...
# Implementation of past loss adjustments based on Version 5, with LSTM model and regular retrain. 
...
class StockMA(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.close_volatility_coefficient = 0.25
        ...
        #v7 param
        self.penalty_coefficient = 0.002
        self.num_days_lookback = 75
